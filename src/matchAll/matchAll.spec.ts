...
describe('matchAll', () => {
  test('matches all occurrences of the regular expression', () => {
  ...
  test('matches all occurrences of the regular expression with submatches', () => {
    expect(matchAll(/(\d+)/g, '$200 and $400')).toEqual([
  ...
  test('matches all occurrences of the regular expression with multiple submatches', () => {
